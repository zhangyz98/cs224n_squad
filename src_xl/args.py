...
import argparse
data_path = "/home/Yizhi/cs224n_squad/"
...
def get_setup_args():
    ...
    parser.add_argument('--dev_meta_file',
                        type=str,
                        default=data_path+'data/dev_meta.json')
    parser.add_argument('--test_meta_file',
                        type=str,
                        default=data_path+'data/test_meta.json')
    parser.add_argument('--word2idx_file',
                        type=str,
                        default=data_path+'data/word2idx.json')
    parser.add_argument('--char2idx_file',
                        type=str,
                        default=data_path+'data/char2idx.json')
    parser.add_argument('--answer_file',
                        type=str,
                        default=data_path+'data/answer.json')
...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file',
                        type=str,
                        default=data_path+'data/train.npz')
    parser.add_argument('--dev_record_file',
                        type=str,
                        default=data_path+'data/dev.npz')
    parser.add_argument('--test_record_file',
                        type=str,
                        default=data_path+'data/test.npz')
    parser.add_argument('--word_emb_file',
                        type=str,
                        default=data_path+'data/word_emb.json')
    parser.add_argument('--char_emb_file',
                        type=str,
                        default=data_path+'data/char_emb.json')
    parser.add_argument('--train_eval_file',
                        type=str,
                        default=data_path+'data/train_eval.json')
    parser.add_argument('--dev_eval_file',
                        type=str,
                        default=data_path+'data/dev_eval.json')
    parser.add_argument('--test_eval_file',
                        type=str,
                        default=data_path+'data/test_eval.json')
